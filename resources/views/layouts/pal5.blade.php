    ...
    <nav class="navbar">
        <div class="container-fluid">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="{{asset('index.html')}}">Admin Kelurahan Pal 5</a>
            </div>
        ...
        <aside id="leftsidebar" class="sidebar">
                ...
                <div class="info-container">
                    ...
                    <div class="btn-group user-helper-dropdown">
                        ...
                        <ul class="dropdown-menu pull-right">
                            ...
                            <li><a href="{{url()->route('logout')}}"><i class="material-icons">input</i>Sign Out</a></li>
                        </ul>
                    </div>
                </div>
            </div>
            ...
            <div class="menu">
                <ul class="list">
                    ...
                    <li>
                        <a class="menu-toggle"><i class="material-icons">content_paste</i><span>Berita</span>
                        </a>
                        <ul class="ml-menu">
                            <li>
                    ...
                    {{-- <li>
                        <a href="{{route('post.index')}}"><i class="material-icons">person_pin</i><span>Post</span></a>
                    </li> --}}
                    ...
                    <li>
                        <a class="menu-toggle"><i class="material-icons">account_circle</i><span> Data Pengurus</span>
                        </a>
                        <ul class="ml-menu">
                            <li>
                    ...
                    {{-- <li class="{{set_active('/kepala_keluarga') }}">
                        <a href="{{url('/kepala_keluarga')}}"><i class="material-icons">person_pin</i><span>Kepala Keluarga</span></a>
                    </li> --}}
                    <li>
