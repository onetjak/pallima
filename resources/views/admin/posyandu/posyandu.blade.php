                    ...
                    <div class="card">
                        <div class="header">
                            ...
                            <ul class="header-dropdown m-r--5">
                                 <a class="btn btn-success" href="{{url('/form_posyandu')}}" style="margin-bottom: 10px">+ Lokasi</a>
                            </ul>
                        </div>
                        <div class="body">
                                                    ...
                                                    <div class="modal-dialog">
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-footer">
                                                                ...
                                                                <a href="{{ url('/posyandu/hapus' , $b->id) }}"class="btn btn-danger">Hapus</a>
                                                            </div>
