        ...
        <div class="container-fluid">
            ...
            <div class="row clearfix">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        <div class="header">
                            <h2>Penambahan Jenis Pelayanan</h2>
                        </div>
                        <div class="body">
                            <form id="form_advanced_validation" action="{{ route('pelayanan.store') }}" method="POST">
                                @csrf
                                ...
                                <div class="form-group form-float">
                                    <div class="form-line">
                                        ...
                                        <textarea id="editor"  name="syarat" class="form-control"></textarea>
                                  </div>
                                </div>
