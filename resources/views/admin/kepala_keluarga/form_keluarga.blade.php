            ...
            <div class="row clearfix">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        ...
                        <div class="body">
                            <form id="form_advanced_validation" action="{{ route('kepala_keluarga.store') }}" method="POST">
                                @csrf
                                ...
                                <div class="form-group form-float">
                                    <div class="form-line">
                                        <input type="text" class="form-control" name="anggota" maxlength="100" minlength="3" required>
